  ...
  return <>
    ...
    <main>
      ...
      <section id="projects" className="section-shell content-section projects-section">
        <div className="section-intro"><p className="kicker">TRAINING &amp; PROJECT WORK</p><h2>Learning applied to real deliverables.</h2></div>
        <div className="project-grid">
          <article className="project-card"><p className="card-label">WINDOWS ENTERPRISE SUPPORT LAB</p><h3>Windows Enterprise<br />Support Lab</h3><p>Built a simulated Windows support environment and resolved 10 Tier 1 incidents across identity, networking, access, applications, printing, storage, and workstation performance. Created a PowerShell diagnostic tool to collect system, network, service, and event-log data for faster troubleshooting.</p><div className="tag-list"><span>PowerShell</span><span>Microsoft Entra ID</span><span>Windows 11</span><span>DNS/DHCP</span><span>Event Viewer</span></div><a className="text-link" href="https://github.com/NickyBartschGit/windows-enterprise-support-lab" target="_blank" rel="noreferrer">Explore lab on GitHub <Arrow /></a></article>
          <article className="project-card featured-project"><p className="card-label">TEAM PROJECT · SAIT</p><h3>Gong Cha Shawnessy<br />Retail Web Application</h3><p>Collaborated on a responsive retail web application, contributing to dynamic menus, user parameters, and UI/UX improvements. Used Jira to track work, document issues, and resolve bugs within an SDLC-based team workflow.</p><div className="tag-list"><span>Jira</span><span>Manual Testing</span><span>UI/UX</span><span>React Fundamentals</span></div><a className="text-link" href="https://gongcha-shawnessy.vercel.app/" target="_blank" rel="noreferrer">View project <Arrow /></a></article>
          <article className="project-card"><p className="card-label">QUALITY ASSURANCE</p><h3>Portfolio QA<br />Testing Report</h3><p>Performed structured manual UI testing across mobile and desktop layouts. Documented test cases, findings, corrections, and lessons learned in a formal QA report.</p><div className="tag-list"><span>QA Testing</span><span>Defect Tracking</span><span>Documentation</span></div><a className="text-link" href="/qa-testing-report.pdf" target="_blank" rel="noreferrer">Read testing report <Arrow /></a></article>
          <article className="project-card support-lab-card"><p className="card-label">HANDS-ON IT SUPPORT LAB</p><h3>IT Help Desk<br />Troubleshooting Lab</h3><p>Built a simulated IT support environment for a 20-employee business. Documented 15 support tickets, Windows and network troubleshooting workflows, a PowerShell diagnostic script, and a ticket-analysis dashboard.</p><div className="tag-list"><span>Windows Support</span><span>Ticket Documentation</span><span>PowerShell</span><span>Data Analysis</span></div><a className="text-link" href="https://github.com/NickyBartschGit/it-help-desk-troubleshooting-lab" target="_blank" rel="noreferrer">Explore lab on GitHub <Arrow /></a></article>
